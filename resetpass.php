    ...
    <body>
        <div class='centerdiv'>
            <form action="" method="post" style="top:50%">
                <h4 class="title is-1" style="margin-top:0">Hrrrrfm... This is a password reset...</h4>
                <input type="text" class="input" name="username" placeholder="Gonna use yer username... Please remember that at least..."><br>
